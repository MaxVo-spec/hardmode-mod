...
public class MoltenSkullBand extends Item {

	public MoltenSkullBand(Properties properties) {
		super(properties);
	...
	public boolean hasEffect(ItemStack stack)
	{
	 ...
	 @Override
	    ...
	    tooltip.add(new StringTextComponent("§7While in your inventory, you get regeneration, fire resistance, and you get healed and stronger when you are burning."));
