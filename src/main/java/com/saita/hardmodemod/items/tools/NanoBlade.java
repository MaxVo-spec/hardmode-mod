...
public class NanoBlade extends SwordItem {

	public NanoBlade(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder) {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		playerIn.addPotionEffect(new EffectInstance(Effects.SPEED, 40, 5));
