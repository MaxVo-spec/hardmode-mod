...
public class PetrifiedPalladiumOre extends Block {

	public PetrifiedPalladiumOre(Properties properties) {
		super(properties);
	...
	public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
		  ...
		  if(worldIn.getGameTime() >= HardmodeGameTimeConstant.HardmodeGameTime)
   	       {	
			  worldIn.setBlockState(pos, BlockInit.PALLADIUM_ORE.get().getDefaultState());
   	       }
