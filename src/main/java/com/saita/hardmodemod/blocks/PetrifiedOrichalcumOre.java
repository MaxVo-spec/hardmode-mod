...
public class PetrifiedOrichalcumOre extends Block {

	public PetrifiedOrichalcumOre(Properties properties) {
		super(properties);
	...
	public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
		  ...
		  if(worldIn.getGameTime() >= HardmodeGameTimeConstant.HardmodeGameTime)
   	       {	
			  worldIn.setBlockState(pos, BlockInit.ORICHALCUM_ORE.get().getDefaultState());
   	       }
