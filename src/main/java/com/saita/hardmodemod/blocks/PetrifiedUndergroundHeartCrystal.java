...
public class PetrifiedUndergroundHeartCrystal extends Block {

	public PetrifiedUndergroundHeartCrystal(Properties properties) {
		super(properties);
	...
	public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
		  ...
		  if(worldIn.getGameTime() >= HardmodeGameTimeConstant.HardmodeGameTime)
   	       {	
			  worldIn.setBlockState(pos, BlockInit.UNDERGROUND_HEART_CRYSTAL.get().getDefaultState());
   	       }
