...
public class ShadowCoreHolderStructure extends Structure<NoFeatureConfig> {
	
    public  ShadowCoreHolderStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return HardmodeMod.MOD_ID + ":shadow_core_holder";
    }
    ...
    {
        return ShadowCoreHolderStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            ShadowCoreHolderPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
