...
public class HardmodeUndergroundTreasureStructure extends Structure<NoFeatureConfig> {
	
    public  HardmodeUndergroundTreasureStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return HardmodeMod.MOD_ID + ":hardmode_underground_treasure";
    }
    ...
    {
        return HardmodeUndergroundTreasureStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            HardmodeUndergroundTreasurePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
