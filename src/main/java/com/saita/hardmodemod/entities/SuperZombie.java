...
public class SuperZombie extends MonsterEntity implements IAnimatedEntity {
...
private EntityAnimationManager manager = new EntityAnimationManager();
	...
	public SuperZombie(EntityType<? extends MonsterEntity> type, World worldIn) {
		super(type, worldIn);
	...
	// Sounds
	  protected SoundEvent getAmbientSound() {
	   ...
	   @Override
		...
		private <E extends SuperZombie> boolean animationPredicate(AnimationTestEvent<E> event) {
			if (event.isWalking()) {
